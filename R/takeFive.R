...
#'    }
#' @seealso  \code{\link{~/Requirements}} For files naming consistency and 
#'  dataset cleaning requirements.
#' @return If all five files are imported correctly, there will be five objects return as original dataset, and there are:
#'  explicit_origin, iat_origin, sessions_origin, tasks_origin, demo_origin.
